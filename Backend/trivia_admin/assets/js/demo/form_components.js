...
$(document).ready(function(){
	...
	if ($.fn.spinner) {
		...
		$( "#spinner-time-start" ).timespinner();
		$( "#culture-time-start" ).change(function() {
			var current = $( "#spinner-time-start" ).timespinner( "value" );
			Globalize.culture( $(this).val() );
			$( "#spinner-time-start" ).timespinner( "value", current );
		});
		
		$( "#spinner-time-end" ).timespinner();
		$( "#culture-time-end" ).change(function() {
			var current = $( "#spinner-time-end" ).timespinner( "value" );
			Globalize.culture( $(this).val() );
			$( "#spinner-time-end" ).timespinner( "value", current );
		});
