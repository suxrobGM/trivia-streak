            ...
            ?>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<a class="btn btn-primary" href="#add-sec-cat">Add Second Level Category</a>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Manage Second Level Categories</h4>
							...
							<div class="widget-content">
								<table class="table table-striped table-bordered table-hover table-checkable datatable-sec-category">
									<thead>
										<tr>
											<th>No</th>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget box">
							...
							<div id="add-sec-cat" class="widget-content">
                               <form class="form-horizontal row-border" id="validate-2" action="action/add_sec_category.php"  method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-md-4">
										 <?php 
                                                ...
                                                if($categories){
                                         ?>
											<select name="parent_category_id" class="select2-select-00 col-md-12 full-width-fix">
                                               <?php 
                                               ...
                                               <?php 
                                                	...
                                                	?>
                                                	<b>Please Add Atleast One Category to add Second Category.</b>
                                                	<?php 
                                                }
                                                ?>
				...
				<!-- /Page Content -->
				 ...
				 <div id="sec-category-edit">
                        		<div class="mws-dialog-inner-sec-category-edit">
                                </div>
                            </div>
                            
				  <div id="sec-category-delete">
                        		<div class="mws-dialog-inner-sec-category-delete" style="display: none;">
